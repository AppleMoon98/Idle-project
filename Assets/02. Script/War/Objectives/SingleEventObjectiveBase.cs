...
namespace War.Objectives
{
    ...
    /// 패턴을 공유하는 War 목표의 공통 베이스. AnnihilationObjective(StageClearedEvent)가 이
    /// 구독/해제/리셋 보일러플레이트를 그대로 쓴다. 연속적 진행도가 있는 목표(CargoProtection/
    /// StructureCapture)는 이 베이스를 쓰지 않는다.
    /// </summary>
